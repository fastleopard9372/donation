                    ...
                    <div class="mySlides fade">
                        <div style="padding:10px 20px 50px 20px; ">
                            ...
                            <div class="views-row views-row-1 views-row-odd views-row-first">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="ACME Markets"><a href="#"><img
                            ...
                            <div class="views-row views-row-7 views-row-odd">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Five Below"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                            ...
                            <div class="views-row views-row-8 views-row-even">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Hy-Vee"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                    ...
                    <div class="mySlides fade">
                        <div style="padding:10px 20px 50px 20px; ">
                            ...
                            <div class="views-row views-row-3 views-row-odd">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Applebee&#039;s"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                            ...
                            <div class="views-row views-row-4 views-row-even">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Auntie Anne&#039;s"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                            ...
                            <div class="views-row views-row-9 views-row-odd">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Northwestern Mutual"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                    ...
                    <div class="mySlides fade">
                        <div style="padding:10px 20px 50px 20px; ">
                            ...
                            <div class="views-row views-row-5 views-row-odd">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Country Time"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                            ...
                            <div class="views-row views-row-11 views-row-odd">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Rita’s Italian Ice"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
                            ...
                            <div class="views-row views-row-12 views-row-even views-row-last">
                                <div class="views-field views-field-field-image">
                                    <div class="field-content">
                                        <a href="#" title="Volvo - Founding Sponsor"><a href="#"><img
                                                    class="image-style-sponsor-slideshow"
...
></script> -->
            ...
            <div id="footer-bottom">
                <p>
                    <a href="<?= SITE_URL ?>products">Home</a> • <a
                        href="<?= SITE_URL ?>products/privacy_policy">Privacy Policy</a> • <a
                        href="<?= SITE_URL ?>products/terms_of_use">Terms of Use •<a
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div id="donateSection"
                ...
                <form class="google-cse" action="<?= base_url('/index.php/products/donate') ?>" target="_top"
